...
class ProfCalculo3(Inimigo):
    def __init__(self, nome: str):
        # Inicializa o professor de Cálculo 3 com um nome específico
        super().__init__(nome)
        self.__vida = 40  # Define a vida inicial do professor
        self._ataque = 8  # Define o valor de ataque do professor
    ...
    def falar(self) -> str:
        # Retorna uma fala aleatória relacionada ao Cálculo 3
