...
class ProfLabSD(Inimigo):
    def __init__(self, nome: str):
        # Inicializa o professor de Laboratório de Sistemas Digitais com um nome específico
        super().__init__(nome)
        self.__vida = 40  # Define a vida inicial do professor
    ...
    def falar(self) -> str:
        # Retorna uma fala aleatória relacionada ao Laboratório de Sistemas Digitais
        fala = self.numero_aleatorio()
        if fala == 1:
            return "VHDL!\n"
        elif fala == 2:
            return "Máquina de Estados Finitos!\n"
        else:
            return "FPGA!\n"
